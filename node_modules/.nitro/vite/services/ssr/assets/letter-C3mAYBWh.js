import { n as NextPageLink } from "./RomanticButton-DUBsQYAh.js";
import { n as PageShell, r as SectionTitle } from "./PageShell-CBxYJShK.js";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/routes/letter.tsx?tsr-split=component
var PARAGRAPHS = [
...
function LetterPage() {
	return /* @__PURE__ */ jsxs(PageShell, {
		eyebrow: "خطاب مكتوب بالإيد وبالقلب",
		children: [
			/* @__PURE__ */ jsx(SectionTitle, { children: "من أحمد... لقطتي. 💌" }),
			/* @__PURE__ */ jsxs("article", {
				className: "animate-rise relative mt-12 overflow-hidden rounded-[2rem] px-6 py-10 shadow-glow sm:px-12 sm:py-14",
				style: {
					animationDelay: "0.2s",
					background: "linear-gradient(170deg, var(--paper), color-mix(in oklab, var(--paper) 82%, var(--gold) 18%))",
				...
				children: [/* @__PURE__ */ jsx("span", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("p", {
							className: "mt-6 text-center font-display text-2xl font-bold sm:text-3xl",
							children: "حبيبتي إيمان،"
						}),
						/* @__PURE__ */ jsx("div", {
							className: "mt-8 space-y-6 text-base leading-[2.35] sm:text-lg",
							children: PARAGRAPHS.map((p, i) => /* @__PURE__ */ jsx("p", { children: p }, i))
						}),
						/* @__PURE__ */ jsx("p", {
							className: "mt-10 text-left font-display text-2xl font-bold sm:text-3xl",
							dir: "rtl",
							children: "أحمد ❤️"
						})
					]
			...
			/* @__PURE__ */ jsx(NextPageLink, {
				to: "/video",
				variant: "gold",
				children: "فيه حاجة عايز الفيديو يقولها 🎬"
			})
		]
	});
}
