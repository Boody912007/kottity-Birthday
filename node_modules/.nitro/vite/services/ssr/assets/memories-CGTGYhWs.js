...
import { n as PageShell, r as SectionTitle, t as Lead } from "./PageShell-CBxYJShK.js";
import { useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/components/birthday/MediaPlaceholder.tsx
	...
	return /* @__PURE__ */ jsxs("figure", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,transparent_55%,color-mix(in_oklab,var(--velvet)_75%,transparent))] opacity-70" })
			]
...
//#endregion
//#region src/routes/memories.tsx?tsr-split=component
var CAPTIONS = [
...
function MemoriesPage() {
	return /* @__PURE__ */ jsxs(PageShell, {
		...
		wide: true,
		children: [
			/* @__PURE__ */ jsx(SectionTitle, { children: "حاجات صغيرة... بس غالية عندي. ❤️" }),
			/* @__PURE__ */ jsxs(Lead, { children: [
				"هنا مكان صورنا...",
				/* @__PURE__ */ jsx("br", {}),
				"كل صورة ليها حكاية.",
				/* @__PURE__ */ jsx("br", {}),
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: CAPTIONS.map((caption, i) => /* @__PURE__ */ jsx(PhotoCard, {
					index: i,
